...
build:
		docker build -t criteria-mysql-converter .

erase: ## Remove the Docker containers of the project.
		docker rmi criteria-mysql-converter

composer-install: ## Install composer dependencies
		docker run --rm -v .:/app criteria-mysql-converter composer install

composer-update: ## Update composer dependencies
		docker run --rm -v .:/app criteria-mysql-converter composer update

phpunit: ## Run PHPUnit
		docker run --rm -v .:/app criteria-mysql-converter vendor/bin/phpunit tests
